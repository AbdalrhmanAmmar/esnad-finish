...
const managementItems = [
  {
    ...
    subItems: [
      ...
      {
        id: "product-messages",
        title: "رفع رسائل المنتجات",
        url: "/management/product-messages",
        icon: MessageSquare,
      },
      {
        id: "doctors-upload",
        title: "رفع ملفات الأطباء",
        url: "/management/doctors-upload",
        icon: Stethoscope,
      },
      {
        id: "pharmacies-upload",
        title: "رفع ملفات الصيدليات",
        url: "/management/pharmacies-upload",
        icon: Pill,
      },
      {
        id: "users-upload",
        title: "رفع ملفات المستخدمين",
        url: "/management/users-upload",
        icon: Users,
      },
      {
        id: "marketing-activities-upload",
        title: "رفع الأنشطة التسويقية",
        url: "/management/marketing-activities-upload",
        icon: Activity,
      },
      {
        id: "lost-orders",
        title: "إدارة الطلبيات المفقودة",
        url: "/management/lost-orders",
        icon: Package,
      },
      {
        id: "site-analytics",
        title: "إحصائيات الموقع",
        url: "/management/site-analytics",
        icon: TrendingUp,
      },
      {
        id: "data-management",
        ...
        subItems: [
          {
            ...
            url: "/management/data/products",
            icon: ShoppingBag,
          },
          {
            id: "doctors-management",
            title: "إدارة الأطباء",
            url: "/management/data/doctors",
            icon: UserMinus,
          },
          {
            id: "pharmacies-management",
            title: "إدارة الصيدليات",
            url: "/management/data/pharmacies",
            icon: Pill,
          },
          {
          ...
          {
            id: "marketing-activities-management",
            title: "إدارة الأنشطة التسويقية",
            url: "/management/marketing-activities",
            icon: Activity,
          },
        ],
      },
  ...
  const getFilteredMenuItems = () => {
    ...
    if (user?.role === "MEDICAL REP" || user?.role === "medical rep") {
      return [
        {
          id: "create-visit",
          title: "تسجيل زيارة عادية",
          url: "/create-visit",
          icon: CalendarPlus,
          requiredRoles: ["MEDICAL REP", "medical rep"],
        },

        {
          id: "visit-analytics",
          title: "تحليلات الزيارات",
          url: "/clinics-analytics",
          icon: BarChart3,
        },
        {
          id: "medical-sales",
          title: "لوحه تحكم المبيعات",
          url: "/analytics/medical-sales",
          icon: DollarSignIcon,
        },

        {
          ...
          subItems: [
            // { id: "clinic-reports", title: "تقرير العيادات", url: "/reports/clinics", icon: Building2 },
            {
              id: "sample-reports",
              title: "تقرير العينات",
              url: "/reports/samples/medical-rep",
              icon: Package,
            },
            {
              id: "marketing-reports",
              title: " الأنشطة التسويقية",
              url: "/reports/marketing/medical-rep",
              icon: TrendingUp,
            },
          ],
        },
      ...
      return [
        ...
        },
        {
          ...
          subItems: [
            {
              id: "work-days",
              title: "إدارة أيام العمل",
              url: "/work-day-calender",
              icon: Calendar,
            },
            {
              id: "documents",
        ...
        },
        {
          ...
          subItems: [
            ...
            {
              id: "create-admin",
              title: "إنشاء أدمن جديد",
              url: "/management/create-admin",
              icon: User,
              requiredRoles: ["SYSTEM_ADMIN"],
            },
            {
    ...
    if (user?.role === "SUPERVISOR") {
      return [
        {
          id: "clinic-analytics",
          title: "لوحه تحكم العيادات",
          url: "/dashboards/clinics/supervisor",
          icon: Building2,
        },

        {
          ...
          subItems: [
            ...
            },
            {
              ...
              title: "طلبات النشاط التسويقي",
              url: "/supervisor/marketing-requests",
              icon: TrendingUp,
            },
          ],
        },
        ...
        <SidebarGroup>
          {!user && (
            <div className="text-center py-8 px-4">
              <p className="text-sm text-muted-foreground">يرجى تسجيل الدخول لعرض القائمة</p>
            </div>
          )}
